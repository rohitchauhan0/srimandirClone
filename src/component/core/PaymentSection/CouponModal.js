    ...
    <div className=' fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 backdrop-blur-sm'>
        <div className=' w-[500px] h-[300px] bg-white rounded-xl flex flex-col items-center gap-5  text-black'>
            ...
            <div className=' flex justify-between items-center gap-10 lg:gap-20'>
              <input type="text" className=' border border-black p-2 rounded-xl' placeholder='Enter coupne code' value={codeValue} onChange={(e)=> setcodeValue(e.target.value)} />
              <button type='button' className=' bg-green-500 p-3 rounded-xl' onClick={()=> handleSubmitCoupne()}>Apply</button>
            </div>
