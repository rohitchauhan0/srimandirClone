      ...
      <div className=" flex flex-col gap-32 lg:mt-40  ">
        <div className=" flex items-center lg:flex-row flex-col justify-center lg:justify-between  lg:px-0 px-2">
          ...
          <div className=" lg:w-[45%] h-full flex flex-col gap-10 ">
            ...
            <div className=" flex">
              <img src={user1} alt="" className=" w-[50px] h-[50px] border-2 border-white rounded-full object-cover" />
              <img src={user2} alt="" className=" w-[50px] h-[50px] border-2 border-white rounded-full object-cover -ml-6" />
              <img src={user3} alt="" className=" w-[50px] h-[50px] border-2 border-white rounded-full object-cover -ml-6" />
              <img src={user4} alt="" className=" w-[50px] h-[50px] border-2 border-white rounded-full object-cover -ml-6" />
              <img src={user5} alt="" className=" w-[50px] h-[50px] border-2 border-white rounded-full object-cover -ml-6" />
            </div>
              <p className=" text-lg">
                Till now{" "}
          ...
          <div className=" w-full mt-20 max-w-screen-xl" id="reviews">
            <div className=" w-full   flex items-start gap-5 flex-col">
              ...
              <p className=" text-2xl  text-gray-500">
                Reviews and Ratings from our customers who performed online Puja
                with us.
              </p>
            </div>
