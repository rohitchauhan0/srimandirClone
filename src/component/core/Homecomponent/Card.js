...
const Card = ({ image, title, text1, text2 }) => {
  return (
    <div className=" p-3 rounded-xl border-[1px] border-gray-400 flex flex-col justify-between min-h-[550px]">
      ...
      <button className=" w-full p-2 rounded-xl bg-green-500 text-white font-bold cursor-pointer">Participate</button>
    </div>
  );
};
